...
export function graph_line_DashBoard(list_xy = data1) {
  let date = list_xy.x
  let yval = list_xy.y
...
export function graph_wr(data_p = data2) {
  const legendName = [
    '0.0-0.2 m/s',
    '0.3-1.5 m/s',
    '1.6-3.3 m/s',
...
function WindRose() {
  ...
  return (
    <div className="WindRose">
      ...
      <button onClick={() => fetchLinechart("000000", 20220423074600, "RH_Avg")}> Linechart Last Month</button>
      <button onClick={() => fetchLinechart("000000", 20220623074600, "RH_Avg")}> Linechart Last 3 Months</button>
      <p>{graph_line(Linexy)}</p>
      <h1>Windrose Graph</h1>
      <button onClick={() => fetchExcuse("000000", 20220719000000)}>Windrose Last month</button>
      <button onClick={() => fetchExcuse("000000", 20220601000000)}>Windrose Last 3 months</button>
